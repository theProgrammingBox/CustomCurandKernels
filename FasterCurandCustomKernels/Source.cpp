...
/*__device__ __constant__ const int32_t kn[128] = {
...
__device__ __constant__ const uint32_t fn[128] = {
...
__device__ __constant__ const uint32_t wn[128] = {
...
__global__ void CudaTest(const void* output, uint32_t seed1, uint32_t seed2)
{
    ...
    float u1 = (((uint16_t*)&seed1)[0] | 1) * weight;
    float u2 = (((uint16_t*)&seed1)[1] | 1) * weight;

    // box muller transform
    float r = sqrtf(negTwo * logf(u1));
